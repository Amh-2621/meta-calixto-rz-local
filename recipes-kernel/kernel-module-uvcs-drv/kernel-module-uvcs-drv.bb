...
COMPATIBLE_MACHINE = "(rzg2l-versa-1gb|rzg2l-versa-2gb|rzg2l-optima-1gb|rzg2l-optima-2gb|rzg2ul-tiny-256mb|rzg2ul-tiny-256mb|rzg2ul-tiny-1gb)"

SRC_URI = "${@oe.utils.conditional('USE_VIDEO_OMX', '1', 'file://uvcs_kernel_package_v4.1.3.0.tar.bz2', '', d)}"
